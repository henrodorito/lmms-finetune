...
TRAIN_DATA_PATH=./example_data/frames_train.json        # path to the training data json file
EVAL_DATA_PATH=./example_data/frames_eval.json          # path to the evaluation data json file (optional)
IMAGE_FOLDER=./example_data/frames                      # path to the image root folder; if provided, the image paths in the json should be relative
